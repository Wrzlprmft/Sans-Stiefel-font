...
\usepackage{adjustbox, alltt, array, balance, caption, calc, color, dblfloatfix, enumerate, enumitem, exscale, fancybox, fancyhdr, fixmath, framed, gensymb, graphicx, graphics, hyphenat, icomma, lipsum, listings, mathcomp, mathtools, mathdots, multicol, multirow, ngerman, nicefrac, placeins, relsize, rotating, tabularx, tikz, titlesec, units, xifthen, xspace, xtab}
...
\setlogokern{Xe}{-0.2em} 
\setlogokern{aT}{-0.075em}
%\setlogodrop{0.4ex}

\newlength{\lw}
\newenvironment{Kasten}[2][3pt]{%
\begin{center}
	\setlength{\lw}{#1}%
...
\begin{Kasten}{0.9\linewidth}
	...
	\textlarger[1]{OpenType-Funktionen mit Beiſpielen für {\addfontfeature{StylisticSet=1} \XeLaTeX}}\\[\baselineskip]	
	Gerrit Ansmann, \today
...
Außerdem ſind ungefähr die Hälfte der Zeichen aus »General Punctuation«, hoch- und tiefgeſtellte Ziffern ſowie einige weitere nicht allzu ſelten auf\/tauchende Zeichen wie €, №, ℗, ℠, ™, ℓ, μ, π, ꝛ, →, ⇒, ∓, ∝, ∞, ≈, ∼, ≡, ≫, ≥ oder ⊥ enthalten.
...
\begin{Kasten}{0.9\linewidth}
	\begin{tabularx}{\linewidth}{C C}
		\Beispiel[Standard]{Quaſtenfloſſer Schmerzmittel Charakterſtück}& \Beispiel[Ligatures=NoCommon]{Quaſtenfloſſer Schmerzmittel Charakterſtück}
	\end{tabularx}
\end{Kasten}
...
In den meiſten gebrochenen Schriften ſind Großbuchſtaben unſchön und ſchwer zu leſen, wenn ſie im Verbund auf\/treten. Stattdeſſen wird normalerweiſe eine externe Antiqua genutzt. Sans Stiefel enthält jedoch Antiqua-Verſionen der in der deutſchen Sprache auf\/tretenden Großbuchſtaben. Dieſe werden mittels OpenType automatiſch genutzt, ſobald zwei Großbuchſtaben aufeinanderfolgen, können aber auch über das OpenType-Feature \texttt{ss01} gezielt aktiviert werden:
\begin{Kasten}{0.9\linewidth}
